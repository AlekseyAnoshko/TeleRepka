...
4. **Трансляция интерактивных сайтов**  - предусмотрено три кнопки вызова любого сайта на экран телевизора с возможность его управления с веб страницы Repka Pi
